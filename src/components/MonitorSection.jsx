...
import monitorcard from "../assets/monitorcard.webp";
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-16 md:py-24">
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24">
        ...
        >
          Explore scheduling features  <FaArrowRightLong className="size-5" />
        </a>
       
        </div>

        <div className="md:w-1/2 w-full">
          <img src={monitorcard} alt="stats image" className="w-full h-auto" />
        </div>
