...
const Footer = () => {
  return (
    <footer className="bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lf:px-8 py-16 pb-8">
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              {" "}
              Copyright © {new Date().getFullYear()} codetutored.com
            </p>
            <p className="text-gray-600">Created by Fehenna Tazrian</p>{" "}
          </div>
        </div>
      </div>
    </footer>
