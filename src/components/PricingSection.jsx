        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="relative px-4">
            <div className="flex items-center gap-2">
              ...
              <input
                className="flex-1 h-2 bg-gray-200 roundd-lg appearance-none cursor-pointer"
                type="range"
                min="1"
                max="50"
                value={productCount}
              ...
              />
              <span className="tetx-xs sm:text-sm text-gray-600">50</span>
            </div>
          </div>
        </div>

        <div className="text-center mt-12">
          <p className="text-xl text-gray-600 mb-4">Reay to Get Started</p>
